...
const LandingPage = () => {
  ...
  return (
    <div className="relative bg-white dark:bg-black text-gray-900 dark:text-white overflow-hidden transition-colors duration-300">
      ...
      <section className="relative py-20 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-black dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {valuePropositions.map((item, index) => (
              <Card key={index} className="bg-gray-900/50 border-gray-700 hover:border-[#008080]/50 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {coreServices.map((service, index) => (
              <Card key={index} className="bg-white/80 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 hover:border-[#FF00FF]/50 transition-all duration-300 hover:transform hover:-translate-y-2 shadow-lg hover:shadow-xl">
                <CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {frameworkSteps.map((step, index) => (
              <div key={index} className="relative group">
                ...
                <Card className="relative bg-white/80 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 hover:border-[#008080]/50 transition-all duration-300 shadow-lg hover:shadow-xl">
                  <CardHeader>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-gray-900/50 border-gray-700 hover:border-[#FF00FF]/50 transition-all duration-300">
                ...
                <CardContent>
                  <div className="space-y-2">
                    {tools.map((tool, toolIndex) => (
                      <Badge key={toolIndex} variant="secondary" className="bg-[#008080]/20 text-[#008080] hover:bg-[#008080]/30 mr-2 mb-2">
                        {tool}
                      </Badge>
                    ))}
                  </div>
